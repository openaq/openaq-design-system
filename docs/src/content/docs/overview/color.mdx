...
<p>Smoke</p>
  ...
  <div id="testWrapper" class="color-test-wrapper">
    {" "}
  </div>
</div>
...
<div class="circle bg-sky-120 color-circle" id="sky120" data-id="#1e64ab">
  <span style="color: white">120</span>
</div>
<div class="circle bg-ocean-120 color-circle" id="ocean120" data-id="#198cff">
  <span style="color: white">120</span>
</div>
